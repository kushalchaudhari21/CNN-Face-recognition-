...
#------------------------------------------------------BOX1 END--------------------------------------------------------
    ...
    # #MODEL 12
    # nn12 = [ConvolutionLayer(5), MaxpoolLayer(3,2), FlattenLayer(), FullyConnectedLayer(17*17,100), TanhLayer(), DropoutLayer(0.6), FullyConnectedLayer(100,10), SoftmaxLayer(), CrossEntropy()]
    # autotrain(nn12, X_train, Y_train, 0.003, 75, 30, "nn12", X_test, Y_test) 

    # MODEL 13 - change self.a at top of this file to change regularisation alpha. 
    nn12 = [ConvolutionLayer(5), MaxpoolLayer(3,2), FlattenLayer(), FullyConnectedLayer(17*17,100), ReLuLayer(), DropoutLayer(0.4), FullyConnectedLayer(100,10), SoftmaxLayer(), CrossEntropy()]
    autotrain(nn12, X_train, Y_train, 0.003, 75, 30, "nn12", X_test, Y_test)  
